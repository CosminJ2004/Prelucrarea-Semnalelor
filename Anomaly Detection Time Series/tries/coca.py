...
if __name__ == "__main__":
    ...
    df = yf.download("KO", start="2019-01-01", end="2024-01-01")['Close']
# Sablon: Covid 2020 (singurul eveniment major recent)
    template = df["2020-02-20":"2020-03-23"]
    ...
    try:
        crash_template = df.loc["2020-02-20":"2020-03-23"]
    except:
